...
type Conference =
    | PublishedConference of ConferenceInfo
    | UnpublishedConference of info:ConferenceInfo * wasEverPublished:bool

module Conference =
    let id conference =
        match conference with
        | PublishedConference info -> info.Id
        | UnpublishedConference (info, _) -> info.Id

    let info conference =
        match conference with
        | PublishedConference info -> info
        | UnpublishedConference (info, _) -> info
